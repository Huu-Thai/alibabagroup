...
$config['licenseName'] = 'http://localhost/alibabagroup/';
$config['licenseKey'] = 'PE7E95TA5V6UM61872NYM9WLC84HX';
...
$config['backends'][] = array(
    ...
    'baseUrl'      => 'http://localhost/alibabagroup/',
    'root'         => $root, // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
