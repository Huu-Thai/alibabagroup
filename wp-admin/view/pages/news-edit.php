...
<form action="index.php?ctr=NewsController&action=handleEditNews" method="post" enctype="multipart/form-data" name="form1" id="form1">
  ...
  <table border="1" align="center" cellpadding="4" cellspacing="0">
      ...
      <td>
        <select name="categoryId" id="categoryId">
          <?php if($data['category'] != false): ?>
            ...
            <option <?=($row['id']==$data['news']['category_id'] ? 'checked' : '') ?> value="<?=$row['id']?>"><?=$row['name']?></option>
            ...
            <?php if($data['cateIdChild'] != false): ?>
              ...
              <?php while($rowChild = mysqli_fetch_assoc($data['cateIdChild'])): ?>
                <option <?=($rowChild['id']==$data['news']['category_id'] ? 'checked' : '') ?> value="<?=$rowChild['id']?>">--<?=$rowChild['name']?></option>
              <?php endwhile; ?>
            <?php endif; ?>
          <?php endif; ?>
        </select>
    ...
    <tr>
      ...
      <td><input name="title" type="text" id="title" value="<?=(isset($data['news']['title']) ? $data['news']['title'] : '') ?>" /></td>
    </tr>
    <tr>
     <td>Hình Ảnh</td>
     <td>
       <input name="urlImage" type=text class="txt" id="urlImage" value="<?=(isset($data['news']['url_image']) ? $data['news']['url_image'] : '') ?>" />
       <label>
  ...
  <tr>
    ...
    <td>
     <label>
       <textarea name="shortDes" id="shortDes" cols="45" rows="5"><?=isset($data['news']['short_description']) ? $data['news']['short_description'] : '' ?></textarea>
     </label>
...
<tr>
  ...
  <td>
   <label>
     <textarea name="description" id="description" cols="45" rows="15"><?=isset($data['news']['description']) ? $data['news']['description'] : '' ?></textarea>
   </label>
   <script type="text/javascript">
...
<tr>
  ...
  <td><input name="keyword" type="text" id="keyword" value="<?=isset($data['news']['keyword']) ? $data['news']['keyword'] : '' ?>" /></td>
</tr>
