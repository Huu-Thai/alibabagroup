...
<form action="index.php?ctr=ProductController&action=handleAddProduct" method="post" enctype="multipart/form-data" name="form1" id="form1">
...
<tr>
  ...
  <td><input name="fee" type="text" id="fee" value="<?=isset($_POST['fee']) ? $_POST['fee'] : '' ?>" /></td>
</tr>

<tr>
  <td width="100">Khoản Thời Gian</td>
  <td><input name="periodTime" type="text" id="periodTime" value="<?=isset($_POST['periodTime']) ? $_POST['periodTime'] : '' ?>" /></td>
</tr>

<tr>
  <td width="100">Phạm Vi Công Việc</td>
  <td><input name="scropeWork" type="text" id="scropeWork" value="<?=isset($_POST['scropeWork']) ? $_POST['scropeWork'] : '' ?>" /></td>
</tr>
