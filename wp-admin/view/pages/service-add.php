...
<form action="index.php?ctr=ServiceController&action=handleAddService" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table border="1" align="center" cellpadding="4" cellspacing="0">
    <tr> <td colspan="2" align="center">THÊM DỊCH VỤ MỚI</td> </tr>
